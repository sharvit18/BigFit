        ...
        <div className="col">
          <div className="card border-0">
            ...
            <div className="card-body">
              ...
              <p className="card-text mb-16 type-default leading-body">Exercising regularly is key to reaching your health and fitness goals, and calculating your workouts calories can help you stay motivated. Whether you prefer running, weightlifting, or yoga, we've got you covered. Start checking your workouts today and take the first step towards a healthier you!</p>
            </div>
          </div>
        </div>
      </div>
